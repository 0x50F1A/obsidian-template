...
const folder = "05 - Literature";

// Function to generate Markdown table content
function generateMarkdownTable(data) {
    const headers = ["File", "Authors", "Title", "Year", "Summary", "Hypothesis", "Methodology", "Results", "Significance"];
...
const filePath = "99 - Meta/10 - Generated/Literature Notes/Summary Table.md";
...
dv.table(["File", "Authors", "Title", "Year", "Summary", "Hypothesis", "Methodology", "Results", "Significance"], data);
```

Generates the table in [[Summary Table]].